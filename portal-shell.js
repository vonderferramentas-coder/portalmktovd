...
(function(){
  ...
  const NAV_ITEMS = [
    ...
    { group:'Criação', items:[
      ...
      { href:'conecta-fg.html', label:'Conecta FG', icon:'<path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/>' },
