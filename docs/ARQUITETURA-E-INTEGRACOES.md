...
| 09/09/2026 | `diagnostico-meta.yml` passou a ecoar cada resposta também no log bruto do passo (além do resumo da execução), para investigar falhas do token direto pela CLI sem depender do navegador. | Equipe de Marketing / manutenção do portal |
